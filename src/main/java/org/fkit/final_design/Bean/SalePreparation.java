...
public class SalePreparation {
	...
	public String toString() {
		return "SalePreparation [id=" + id + ", staff_id=" + staff_id + ", house_name=" + house_name + ", house_estate="
				...
				+ ", house_client_remark=" + house_client_remark + ", state=" + state + ", permit_time=" + permit_time
				+ "]";
	}
